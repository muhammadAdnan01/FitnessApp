...
Controller.create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var body, heartRateBody, data, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, model.HeartRate.create(heartRateBody)];
            case 2:
                data = _a.sent();
                res.send(data);
                return [3 /*break*/, 4];
...
Controller.findAllPublished = function (req, res) {
    model.HeartRate.findAll()
        ...
        .catch(function (err) {
        res.status(500).send({
            message: err.message || 'Some error occurred while retrieving HeartRates.',
        });
    });
};
