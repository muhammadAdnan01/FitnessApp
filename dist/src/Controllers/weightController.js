...
Controller.create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var body, sleepDurationsBody, data, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, model.weight.create(sleepDurationsBody)];
            case 2:
                data = _a.sent();
                res.send(data);
                return [3 /*break*/, 4];
...
Controller.findAllPublished = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, model.weight.findAll()];
            case 1:
                data = _a.sent();
                res.send(data);
                return [3 /*break*/, 3];
            case 2:
                error_2 = _a.sent();
                res.status(500).send({
                    message: error_2.message || 'Some error occurred while retrieving weight.',
                });
                return [3 /*break*/, 3];
